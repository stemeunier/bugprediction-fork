...
class TestPDependConnector(unittest.TestCase):
    ...
    def test_compute_metrics(self):
        ...
        self.assertEqual(metric.pdepend_cbo, 5.26)
        ...
        self.assertEqual(metric.pdepend_nopm, 5.53)
        self.assertEqual(metric.pdepend_vars, 3.95)
        self.assertEqual(metric.pdepend_wmc, 17.58)
